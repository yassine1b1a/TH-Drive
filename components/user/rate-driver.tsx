...
export function RateDriver({ rideId, raterId, ratedId, driverName }: RateDriverProps) {
  ...
  return (
    <Card className="mx-auto max-w-md">
      ...
      <CardContent className="space-y-6">
        <p className="text-center text-muted-foreground">How was your ride with {driverName}?</p>
